...
Both display **D-Mail**. Version remains **0.1.11**, code **100011**.

Run `./scripts/build-release --appgallery` to produce
`dist/D-Mail-0.1.11-arm64-v8a-appgallery-unsigned.app` and the corresponding ZIP
...
The completed local upload file is:
